...
void connectToServer() {
  ...
  if (client.connect(serverHost, serverPort)) {
    ...
    // После подключения сразу просим Arduino заново прислать список команд.
    // Это решает ситуацию, когда стартовый capabilities был отправлен до подключения ESP к серверу.
