...
class FollowControllerCar2(BaseFollowController):
    """Регулятор для второй машинки.

    Менять алгоритм второй машинки нужно здесь, не в server.py.
    Сейчас закон управления такой же, как у car1, но файл отдельный — можно
    спокойно менять коэффициенты/логику только для второй машинки.
    """
    ...
    def compute_control(self, p, dt, K, target_d, distance_valid, gyro_valid):
        ...
        return target_u_v, target_u_w, {'algorithm_file': 'controllers/follow_car2.py'}
